...
SWIFT_CLASS("_TtC4Bond22TextFieldDynamicHelper")
@interface TextFieldDynamicHelper : NSObject
@property (nonatomic, weak) NSTextField * __nullable control;
@property (nonatomic, copy) void (^ __nullable listener)(NSString * __nonnull);
- (SWIFT_NULLABILITY(nonnull) instancetype)initWithControl:(NSTextField * __nonnull)control OBJC_DESIGNATED_INITIALIZER;
- (void)textChanged:(id __nullable)sender;
@end
